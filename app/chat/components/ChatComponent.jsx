...
import TopoDoChat from './TopoDoChat';
import CampoDeTexto from './CampoDeTexto';
import Mensagem from './Mensagem';
import { getContatoInfo, scrollParaFim, enviarMensagem } from './utils';

const API_BASE = process.env.NEXT_PUBLIC_API_URL || 'http://localhost/api/db';
